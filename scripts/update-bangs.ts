 ...
 */
function fetchBangData(): Promise<Array<BuiltInBang>> {
 ...
 */
function convertBangFormat(bangs: Array<BuiltInBang>) {
 ...
 */
function generateBangFileContent(bangs: Array<BuiltInBang>) {
 ...
 */
function writeBangFile(content: string) {
