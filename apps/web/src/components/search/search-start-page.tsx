...
type SearchStartPageProps = {
  ...
  defaultSetup?: React.ReactNode;
  search: React.ReactNode;
};

export function SearchStartPage({ centerOnShortViewports = false, defaultSetup, search }: SearchStartPageProps) {
  return (
    <Page centered centerOnShortViewports={centerOnShortViewports}>
